...
*All three work for both landscaping/pressure washing AND recurring mowing.*

- **Option A: "Summer Refresh"** — transformation angle, works for cleanups, pressure washing, and lawn care equally
...
## 2. 💡 Hero Headline Options
*Lead with the transformation/landscaping angle — mowing is the natural next step.*

- **A:** "Your Property Deserves More Than a Mow" / Full-service landscaping, pressure washing & lawn care — Covington, GA
...
|---|---|---|
| Driveway Only | Concrete/asphalt driveway, up to 2-car | $197–$250 |
| House Exterior | All siding + fascia, single-story | $250–$350 |
| Full Property | Driveway + house exterior + walkways | $400–$550 |
...
### 🌿 Landscaping Cleanup Packages

| Package | What's Included | Suggested Price |
|---|---|---|
| Basic Cleanup | Edge beds, pull weeds, haul debris | $150–$250 |
| Full Bed Refresh | Weed, edge, install mulch (2–3 bags), define borders | $300–$500 |
| Mulch & Weed Barrier | Lay landscape fabric + 3–5 bags mulch per bed | $250–$450 |
| Bush & Shrub Trim | Shape all bushes/shrubs, haul clippings | $125–$250 |
| Tree Trimming (small) | Trim limbs up to 15ft, haul debris | $200–$400 |
...
```
High-ticket job completed (PW, cleanup, mulch)
  → On-site upsell conversation (same day)
    → Follow-up text (Day 3)
      → Follow-up text (Day 10)
        → Recurring mowing client signed
```

---

### On-Site Talking Points (say this while finishing the job)
...
**Day 3 (after job):**
> *"Hey [Name], this is [Your name] from Lawn Masters V5. Hope you're loving how the yard looks! Just wanted to let you know our weekly mowing routes for your area are filling up for the summer. Want to lock in a spot? Starting at $90/mo biweekly or $120/mo weekly. Just reply and I'll get you set up."*

**Day 10 (if no reply):**
> *"Hey [Name] — last check-in from us! Summer mowing slots in [neighborhood] are almost full. Reply YES and we'll add you to the route, no paperwork needed."*

**Day 30 (cold re-engage):**
> *"Hey [Name], Lawn Masters V5 here. We're back in your area this week — want a quick cleanup or another pressure wash before the summer heat peaks? Also still have 1–2 mowing spots open in your neighborhood."*

**Owner decision on scripts:** [ ] Approve [ ] Revise
...
| Day | Action |
|---|---|
| Same day | On-site verbal upsell |
| Day 1 | Send invoice/payment link via Zelle confirmation text |
| Day 3 | Upsell text (mowing pitch) |
| Day 10 | Second follow-up if no reply |
| Day 30 | Re-engage for next high-ticket job OR mowing |
...
### Back — Mowing as the Natural Next Step
...
| Area | Lead With | Why |
|---|---|---|
| Covington near Hwy 278 | Pressure washing | Older homes, visible mildew staining on driveways/siding |
| Oxford near Oxford College | Landscaping cleanup | Tree-lined lots with overgrown beds by June |
| Conyers off Hwy 138 | Full Property PW + mowing bundle | Dense suburban, HOA pressure, high volume per route |
| Porterdale | One-time cleanup → mowing pitch | Budget-conscious, get in the door with a $150 cleanup |
| Social Circle | Landscaping + mowing combo | Lower competition, homeowners receptive to full-service |
| Monroe | PW or gutter cleaning | Slightly higher income, willing to pay for convenience |

**💡 Tip:** Lead with pressure washing in neighborhoods with older concrete driveways — the before/after sells itself and requires no explanation. Landscaping requires more trust. PW closes faster.

**Owner decision on first neighborhoods:** [ ]

---

## 7. 📱 Instagram Content Plan

### 5 Post Ideas

**Post 1 — Pressure Washing Transformation (Reel)**
Before/after of a Covington driveway. Text overlay: *"$220. 90 minutes. Newton County."* No pitch needed — the visual does the work. Strong save/share bait.

**Post 2 — "The Combo" Post**
Side-by-side: dirty driveway + overgrown beds BEFORE / clean driveway + fresh mulch AFTER. Caption: *"Pressure washed the driveway, refreshed the beds, and set them up on weekly mowing. One call."*
...
- **PW time-lapse** — Wide angle, one driveway start to finish. 30 seconds. No music needed — the pressure washer sound IS the content.
- **The combo reveal** — Show the full property before, then fast-cut to after (PW + beds + cut lawn). 45–60 seconds. Text overlay: *"One call. Full property."*
- **"What we do in a day"** — Follow the crew through 2–3 jobs in one day. Raw, no edits needed. Authentic > polished for this market.
- **Customer reaction** — Film the homeowner seeing the finished driveway for the first time. Ask permission first. Gold content.

---

### #️⃣ Hashtag Strategy (mix 10–15 per post)
...
| Metric | Wk1 | Wk2 | Wk3 | Wk4 | Wk5 | Wk6 |
|---|---|---|---|---|---|---|
| 🚪 Door hangers | 150 | 150 | 200 | 200 | 100 | 100 |
| 📸 Instagram posts | 3 | 3 | 3 | 3 | 3 | 3 |
| 💰 High-ticket quotes sent | 3 | 5 | 5 | 6 | 5 | 4 |
| 💰 High-ticket jobs closed | 1–2 | 2–3 | 3 | 3–4 | 3 | 2–3 |
| 🔄 Upsell convos had (on-site) | 1–2 | 2–3 | 3 | 3–4 | 3 | 2–3 |
| ✅ New recurring mowing clients | 0–1 | 1–2 | 2 | 2–3 | 2 | 1–2 |
| 👥 Running mowing total | 13 | 15 | 17 | 20 | 22 | 23–24 |

**💡 Revenue lens:**
- 3 PW jobs/week @ avg $300 = $900 high-ticket revenue
...
> ✅ Next step: Owner fills in decisions above → Claude Code builds the `/summer` landing page and updates `lib/spring-rush-content.ts` with new campaign copy.
