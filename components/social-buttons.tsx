  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex flex-row gap-2">
        ...
        >
          <svg
            className="w-9 h-9 fill-[#25D366] group-hover:fill-white transition-colors mt-3 ml-2"
            viewBox="0 0 24 24"
        ...
        {/* Facebook - Top Right */}
        <a
          href="https://www.facebook.com/profile.php?id=61586389722504"
          target="_blank"
          rel="noopener noreferrer"
        ...
        >
          <svg
            className="w-9 h-9 fill-[#1877F2] group-hover:fill-white transition-colors mt-3 -ml-2"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <div className="flex flex-row gap-2">
        ...
        >
          <svg
            className="w-9 h-9 fill-[#E4405F] group-hover:fill-white transition-colors -mt-1 ml-2"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          <MessageCircle className="w-9 h-9 text-primary group-hover:text-white transition-colors -mt-2 -ml-2" />
        </a>
      </div>
    </div>
  )
