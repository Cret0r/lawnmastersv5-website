...
| `NOTEBOOK.md` | The owner's hand-copyable field notebook (v3 — solo-owner + GA-pricing corrected): offers, ideal customer, funnel, scripts (EN/ES), weekly scorecard, money rules, pushback lines |
