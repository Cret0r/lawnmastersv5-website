# Lawn Masters V5 — Business Playbook

> Everything about how this business works, written so a stranger could pitch it tomorrow.
> Sources: SUMMER_CAMPAIGN_2026.md, output/HORMOZI_SUMMER_OFFER.md, site content, session history.
...
| Fact | Value |
|---|---|
| Legal name | Lawn Masters V5 INC |
| Phone | (407) 600-0301 (Florida area code — real number, do not change without owner) |
...
## 2. Service Area (owner-locked list)

Covington (HQ), Conyers, Oxford, Porterdale, Social Circle, Monroe — Newton County GA and edges of Rockdale/Walton. **Do not add or remove cities without owner confirmation.** Canonical list: `lib/business-info.ts` → `BUSINESS.cities`.

Neighborhood intelligence (from campaign research):
| Area | Lead with | Why |
|---|---|---|
| Covington / Hwy 278 | Pressure washing | Older homes, visible driveway/siding mildew |
| Oxford / Oxford College | Landscaping cleanup | Tree-lined lots, overgrown beds by June |
| Conyers / Hwy 138 | Full-property PW + mowing bundle | Dense suburbs, HOA pressure, route density |
| Porterdale | $150 basic cleanup → mowing upsell | Budget-conscious entry point |
| Social Circle | Bilingual angle | Lower competition, underserved Spanish speakers |
| Monroe | PW + gutter combo | Higher income, pays for convenience |
...
```
High-ticket job completed (PW/cleanup)
  → same-day on-site upsell ("protect the investment you just made")
    → Day 3 follow-up text → Day 10 follow-up → Day 30 re-engage
      → recurring mowing client
```
Key framing: mowing is never pitched as a separate sale — it's positioned as **protecting the transformation they just paid for**.
...
Homeowners in Newton County suburbs who: (a) just watched their property get away from them (overgrowth, stained driveway), (b) fear HOA letters (Conyers especially), (c) have been burned by flaky solo lawn guys, or (d) prefer doing business in Spanish. They buy reliability, not horticulture. The emotional product is *"I never think about my yard and it always looks good."*

---

## 6. Brand Voice Rules

- Plain, direct, working-class confident. No corporate fluff, no "elevate your outdoor living experience."
- Lead with transformation and proof (before/after photos do the selling).
- Guarantees stated bluntly, benefits over features, specific numbers over adjectives.
- "Se Habla Español" is displayed prominently (hero-level, not footer fine print) — it's a moat, not a footnote.
- Never claim "Licensed & Insured" — **not currently accurate**; removed from all copy in session 6. Do not re-add without owner confirmation.
- Reviews use first name + last initial + city only.
- Design voice: forest green (`primary`), DM Serif Display headings, warm off-white backgrounds — see ARCHITECTURE.md design tokens.

---

## 7. Current State & Honest Weaknesses (July 2026)
